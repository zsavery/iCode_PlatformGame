...
public class CloudEnemy
{
    ...
    public void Oscillate(Grid g, PlatformGame.MainPage page)
    {
        int boundaryLeft = 0;
        int boundaryRight = 4;
    ...
    async public void MoveLeft(Grid g, int limitLeft, int limitRight, PlatformGame.MainPage page)
    {
        while (col > limitLeft)
        {
            col--;
    ...
    //MoveRight Function
    // ---> if enemy collides with user Destroy() user
    async public void MoveRight(Grid g, int limitLeft, int limitRight, PlatformGame.MainPage page)
    {
